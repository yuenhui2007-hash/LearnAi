...
// Each entry: { detailed: html_string, summary: [strings], tips: [strings] }
// ============================================================================
...
for (const file of files) {
  ...
  // Skip if already has substantial detailed content
  const h3Count = (html.match(/<h3>/g) || []).length;
  const hasGoodContent = h3Count >= 3 && html.length > 8000 && !html.includes('Coming Soon') && !html.includes('coming-soon');
  if (hasGoodContent) { skipped++; continue; }
