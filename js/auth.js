...
window.Auth = {
  ...
  login: function(email, password) {
    ...
    localStorage.setItem(AUTH_KEY, JSON.stringify(user)); return { success: true, user };
  },
  logout: function() { localStorage.removeItem(AUTH_KEY); localStorage.removeItem('token'); localStorage.removeItem('user'); window.location.href = 'index.html'; },
  getUser: function() {
